        ...
        <Layout style={[styles.container]}>
          <SafeAreaView edges={["top"]} style={{ flex: 1 }}>
            ...
            >
              ...
              <ListItem
                iconName="account"
                title="Create a Personalized Scene"
                subtitle="Easily design and save custom scenes."
              />
              <ListItem
                iconName="lightbulb-group"
                title="Optimize Energy Usage"
                subtitle="Conserve energy where it matters."
              />
              <ListItem
                iconName="security"
                title="Boost Your Security"
                subtitle="Security reccommendations."
              />
              <ListItem
                iconName="home-automation"
                title="Automate routine tasks."
                subtitle="Automations based on room functions."
              />
              <ListItem
                iconName="chart-bar-stacked"
                title="Get insights and reports."
                subtitle="Personalized reports on home."
              />
              {/* Bottom SHEET Modals */}
            </ScrollView>
          </SafeAreaView>
